...
$l['scheduled_tasks_desc'] = "Zde můžete spravovat úlohy, které se automaticky spustí ve zvolený čas ve tvém fóru. Pokud chcete spustit úlohu, hned teď, tak klikněte na ikonku vpravo od úlohy.";
...
$l['time_days_of_month_desc'] = "Zadejte dny, které budou odděleny ',' (čárkou) ve kterých chceš provést tuto úlohu. Zadejte '*', pokud chcete, aby úloha běžela každý den nebo vyber z nabídky den, která se nachází níže.";
...
$l['confirm_task_deletion'] = "Jste si jistý, že doopravdy chcete vymazat tuto naplánovanou úlohu?";
