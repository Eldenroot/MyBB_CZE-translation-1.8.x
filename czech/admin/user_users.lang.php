...
$l['browse_users_desc'] = "Níže můžeš listovat mezi zaregistrovanými uživateli a zobraziBelow you can browse users of your forums in different defined views. Views are particularly useful for generating different result sets with different information - think of them as saved live searches.";
$l['find_users'] = "Najít uživatele";
$l['find_users_desc'] = "Zde můžeš vyhládat uživatele tvého fóra. The fewer fields you fill in, the broader your search is; the more you fill in, the narrower your search is.";
...
$l['edit_user_desc'] = "Zde můžeš upravit uživatelovi profil a jeho nastavení, podpis. Také zde můžeš vidět základní statistiky uživatele. and visit other pages for further information relating to this user.";
...
$l['warning_coppa_user'] = "<p class=\"alert\"><strong>Upozornění: </strong> This user is awaiting COPPA validation. <a href=\"index.php?module=user-users&amp;action=activate_user&amp;uid={1}\">Activate Account</a></p>";
...
$l['recieve_pms_from_buddy'] = "Dostávat soukromé zprávy pouze od přátel (this setting has no effect unless there is at least one buddy on the list)";
...
$l['source_account_desc'] = "This is the account that will be merged in to the Hlavní účet. It will be removed after this process.";
$l['destination_account'] = "Primární účet";
$l['destination_account_desc'] = "This is the account that the Vedlejší will be merged in to. It will remain after this process.";
