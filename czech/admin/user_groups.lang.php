...
$l['can_email_users'] = "Can send threads to friends and e-mail users?";
$l['can_email_users_override'] = "Can e-mail users even if they appear on their ignore list?";
...
$l['email_flood_time_desc'] = "The number of minutes a user must wait after sending an e-mail before they can send another. If set to 0, there is no wait.";
