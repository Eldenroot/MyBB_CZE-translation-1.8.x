...
$l['add_new_setting_desc'] = "V této části můžete přidat nové nastavení pro tvé fórum.";
...
$l['name_desc'] = "Tento jedinečný identifikátor se používá v poli nastavení k odkazu na tohle nastavení (ve skriptech, překladech a šablonách).";
...
$l['error_missing_name'] = "Nezadal(a) jste identifikátor pro tohle nastavení.";
$l['error_missing_group_name'] = "Nezadal(a) jste identifikátor pro tuto skupinu nastavení.";
$l['error_invalid_type'] = "Pro tohle nastavení jste nevybral(a) platný typ.";
