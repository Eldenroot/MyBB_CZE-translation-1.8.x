...
$l['pmdata_recipient_is_ignoring'] = "Osoba, které se pokoušíte zaslat soukromou zprávu, Vás má umístěného v seznamu ignorovaných uživatelů. Vaše zpráva jí tedy nemůže být odeslána.";
$l['pmdata_recipient_has_buddy_only'] = "Nemůžete poslat zprávu příjemci {1}, protože Vás nemá ve svém seznamu přátel.";
$l['pmdata_recipient_pms_disabled'] = 'Osoba {1}, které se pokoušíte zaslat soukromou zprávu, si tuto možnost vypnula. Vaše zpráva jí tedy nemůže být odeslána.';
$l['pmdata_recipient_reached_quota'] = 'Osoba {1}, které se pokoušíte zaslat soukromou zprávu, má zcela plnou schránku pro jejich příjem. Vaše zpráva jí tedy nemůže být odeslána.';
