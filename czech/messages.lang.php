...
$l['error_nomessage'] = "Nelze bohužel pokračovat, protože tato zpráva není validní. Vraťte se prosím a opravte ji.";
$l['error_invalidemail'] = "Uvedená emailová adresa není platná.";
...
$l['error_uploadempty'] = "Vybraný soubor je prázdný.";
...
$l['error_uploadfailed_php6'] = "PHP hlásí: chybí dočasné složky souborů. Informujte laskavě administrátora fóra o této chybě.";
$l['error_uploadfailed_php7'] = "PHP hlásí: soubor se nepodařilo zapsat na disk. Informujte laskavě administrátora fóra o této chybě.";
$l['error_uploadfailed_phpx'] = "PHP ohlásilo chybu číslo: {1}. Informujte laskavě administrátora fóra o této chybě.";
...
$l['error_emailmismatch'] = "E-mailová adresa není platná. Vraťte se prosím a zkuste to znovu.";
$l['error_nopassword'] = "Nebylo zadáno správné heslo.";
$l['error_usernametaken'] = "Zvolené uživatelské jméno je již bohužel registrováno. Pokud jste se již dříve registroval(a), prosím <a href=\"member.php?action=login\">přihlašte se</a>.";
...
$l['error_nopermission_user_4'] = "Váš účet stále ještě čeká na aktivaci nebo povolení moderátora.";
...
$l['error_max_emails_day'] = "Nemůžete použít funkci 'Odeslat téma příteli' nebo 'Napsat uživateli e-mail' neboť máte vyčerpanou přidělenou čtyřiadvacetihodinovou kvótu k odeslání {1} zpráv.";
$l['attachments_disabled'] = "Nemůžete použít přílohy, administrátor to zakázal.";
...
Budete muset zadat následující údaje:
Uživatelské jméno: {1} (nebo Vaši emailovou adresu)
Aktivační kód: {5}
...
$l['email_reportpost'] = "{1} z {2} ohlásil tento příspěvek:

{3}
{4}/{5}

Důvod, který uživatel uvedl ke svému ohlášení:
{7}

Tato zpráva byla odeslána všem moderátorům fóra. Pokud neexistují, tak jeho administrátorům a supermoderátorům.

Ohlášený příspěvek si prosím přečtěte co nejdříve.";
...
Toto heslo potřebujete k prvnímu přihlášení se do fóra. Poté si heslo již sami můžete snadno změnit ve Vašem Nastavení uživatele.
...
Uživatelské jméno: {3} (nebo Vaše emailová adresa)
Heslo: {4}
...
obdrželi jsme Vaši žádost z {2}, týkající se změny Vaší emailové adresy. Detaily:

Stará e-mailová adresa: {3}
Nová e-mailová adresa: {4}

Pokud jsou tyto změny správné, dokončíte změnu na {2} kliknutím na následující odkaz:
...
Pokud jste se rozhodli nedokončit validační proces a neověřit tak Vaši novou emailovou adresu, nebude Váš uživatelský profil aktualizován a stále bude obsahovat Vaši starou emailovou adresu.
...
Tato změna byla automaticky zpracována. Pokud jste si tuto změnu nevyžádali, prosím kontaktujte administrátora.
...
Pro prohlédnutí zprávy, odpověď či její přeposlání klikněte na následující odkaz:
...
Pokud nechcete, aby Vám ostatní členové mohli posílat emaily, jděte do svého Nastavení uživatele a tam si nastavte 'Skýt emailovou adresu před ostatními uživateli':
{4}/usercp.php?action=options
